  ...
  return (
    <>
      ...
      <div className='buttflex'>
        <button className="main_buttons" onClick={() => changeText("Header №1")}>Click me for different header!</button>
        <button className="main_buttons" onClick={() => changeText("Header №2")}>Click me for different header!</button>
        <button className="main_buttons" onClick={() => changeText("Header №3")}>Click me for different header!</button>
        <button className="main_buttons" onClick={() => changeText("Header №4")}>Click me for different header!</button>
      </div>
    </>
  );
}
